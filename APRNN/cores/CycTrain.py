...
from cores.CycleRNN import Model
...
def get_arguments():
    ...
    parser.add_argument('--save_dir', type=str, default='../save_cyc',
    ...
    with tf.Session() as sess:
        ...
        for e in range(args.num_epochs):
            ...
            for b in range(0, train_index):
                ...
                feed = {model.input_data: x, model.input_cycle_data: x, model.targets: y}
